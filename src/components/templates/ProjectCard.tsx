...
export const ProjectCard = ({ isLeft, images, title, description, liveDemo, githubClient, githubServer, techStack }: Project & { isLeft?: boolean }) => {
    return (
        <div className={`flex flex-wrap md:flex-nowrap gap-9 py-14 max-w-7xl px-8 ${isLeft ? "md:flex-row-reverse" : ""}`}>
